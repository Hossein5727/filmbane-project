...
function UserMenu({ setIsOpenUserMenu, logOut }) {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bgUserMenu flex justify-start items-start px-6 py-28 z-[5] inset-0">
      <div
        ref={userRef}
        className="bg-citrine px-5 py-4 rounded-md animate__animated animate__zoomIn flex flex-col gap-6"
      >
        <div className="flex justify-start items-start border-b border-opacity-50 border-rich-black-fogra-29 rounded-sm pb-2 gap-2 text-2xl w-60 text-black">
